    ...
    public:
        TEST_METHOD(Test01_CorrectGraph)
        {
            std::vector<std::string> lines = {
                ...
                "3 -- 4",
                "4 -- 5",
                "1 [label = \"moscow; öåíà 63,72\"]",
                "2 [label = \"rostov; öåíà 73,23\"]",
                "3 [label = \"voronezh; öåíà 65,56\"]",
                "4 [label = \"ufa; öåíà 74,52\"]",
                "5 [label = \"samara; öåíà 56,72\"]",
                "}"
            };
            Graph g;
        ...
        TEST_METHOD(Test14_VertexUnexpectedAttr)
        {
            std::vector<std::string> lines = {
                "graph G {",
                "1 [label = \"moscow; öåíà 63,72\", shape=\"box\"]",
                "}"
            };
            Graph g;
            bool result = parseDot(lines, g);
        ...
        TEST_METHOD(Test16_VertexLabelThreeParams)
        {
            std::vector<std::string> lines = {
                "graph G {",
                "1 [label = \"moscow; öåíà 63,72; extra\"]",
                "}"
            };
            Graph g;
            bool result = parseDot(lines, g);
